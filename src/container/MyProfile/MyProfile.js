        ...
        <View
            ...
            <TouchableOpacity
              ...
              {!index ? (
                <Image
                  ...
                  style={styles.picImagestyle}></Image>
              ) : (
                <View
          ...
          <TouchableOpacity
            ...
            <Image
              ...
              style={styles.settingImage}></Image>
          </TouchableOpacity>
        </View>
                ...
                <View style={{ position: "relative" }}>
                  <Image
                    ...
                    style={styles.favImagestyle} />
                    {
                      ...
                      <Text style={styles.notificationtextstyle}>{notification?.length > 0 ? notification?.length : "0"}</Text>:null
                    }
...
const styles = StyleSheet.create({
  ...
  lastImagestyle:{height:"40%",width:"40%" ,resizeMode:'contain',marginBottom:150},
});
