...
const RecycleBin = () => {
  ...
  const renderItem = ({ item }) => (
    <View style={styles.slideOuter}>
      ...
      <View
        style={styles.ratingMainWrapper}>
        <View
          style={styles.ratingSubChild}>
          <TouchableOpacity
            onPress={() => {
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <Image
              ...
              style={styles.ratingImage}></Image>
          </TouchableOpacity>
        </View>
      </View>
      <TouchableOpacity
      ...
      <View
        ...
        <Text
          numberOfLines={1}
          style={styles.propertyTitleText}>
          {item?.title}
        </Text>
      </View>
      <KeyboardAvoidingView>
                ...
                <ScrollView
                  ...
                  <View style={styles.maincov}>
                    ...
                    <View style={styles.labelcover}>
                      ...
                      />
                      <View
                        style={styles.propertlabel}></View>
                    </View>
      ...
      <View
        style={styles.bottomMainWrapper}>
        {DeviceInfo.getDeviceType() === 'Tablet' ? (
          <View
            style={styles.bottomTabWrapper}>

            <View
              style={styles.bottomVerticleWrap}>
          ...
          <ScrollView
            ...
            <View
              style={styles.phoneBottomMain}>
              <View
                style={styles.phoneBottomChild}>
                <View
                  style={styles.phoneItemMain}>
                  <View
                    style={styles.phoneItemSubChild}>
                    <Image
                      source={Images.newbed}
                      style={styles.phoneItemImage}></Image>
                    <Text
                      style={styles.phoneItemText}>
                      {item.property_bedrooms.length > 0
                        ? item.property_bedrooms
                        : 0}{' '}
                      {'Beds'}
            ...
            onEndReached={() => {
              ...
              dispatch(getTrash(limit + 1)).then(response => {
                if (response?.payload?.data?.length > 0) {
                  setHomeData(prevData => [...prevData, ...response?.payload?.data]);
                }
              });
            }}
...
const styles = StyleSheet.create({
  ...
  sortbycover:{width:"100%", zIndex:9,alignItems:"center",position: "absolute",},
  loaderstyle1: {
    height: '100%',
    width: '100%',
    flex: 1,
