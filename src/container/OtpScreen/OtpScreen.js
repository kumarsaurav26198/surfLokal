...
const authToken = route.params?.authToken;
  ...
  useEffect(() => {
    getUsrID()
    console.log('loginPhoneUser ==== > ',store?.getState().loginPhoneUser)
  }, [])
  ...
  const verify_OTP = () => {
    if (otp.length < 6) {
      ...
      const Header = {
        ...
        access_token: props.route.params.authToken, 
      };
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View
        ...
        <TouchableOpacity
          style={styles.changeNumber} onPress={() => { navigation.goBack() }}>
          <Text
        ...
        <TouchableOpacity
          ...
          <View style={styles.resendOTPView}>
            <Text
              style={styles.resendOtpTextView}>
