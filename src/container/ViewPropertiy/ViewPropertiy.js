        ...
        <View style={styles.detailView}>
          <View style={styles.viewstyle}>
            <View style={styles.view1}>
              ...
              <Text style={styles.props}>
                Price: <Text style={styles.fontstyle}>
                  {data?.details?.property_details?.price}
                </Text>
              </Text>
              <Text style={styles.props}>
                Est. Taxes: {' '} <Text style={styles.fontstyle}>
                  {data?.details?.property_details?.taxes}
                </Text>
              </Text>
              <Text style={styles.props}>
                Bedrooms: {' '} <Text style={styles.fontstyle}>
                  {data?.details?.property_details?.bedrooms}
                </Text>{' '}
              </Text>
              <Text style={styles.props}>
                Bathrooms: {' '} <Text style={styles.fontstyle}>
                  {data?.details?.property_details?.bedrooms}
                </Text>
              </Text>
              <Text style={styles.props}>
                Size:  <Text style={styles.fontstyle}>
              ...
              <Text style={styles.props}>
                Garage Spaces: <Text style={styles.fontstyle}>
                  {data?.details?.property_details?.garagespaces}
                </Text>
              </Text>
              <Text style={styles.props}>
                Lot Size:  <Text style={styles.fontstyle}>
                  {data?.hoa_fee}
                </Text>
              </Text>
              <Text style={styles.props}>
                Year Built :  <Text style={styles.fontstyle}>
                  {data?.details?.property_details?.yearbuilt}{' '}
                </Text> {' '}
              </Text>
              <Text style={styles.props}>
                Total Stories: {' '} <Text style={styles.fontstyle}>
            ...
            <View style={styles.detailmiddleview}>
              ...
              <Text style={styles.props}>
                Community Name: {' '}  <Text style={styles.communityText}>
                  {data?.details?.community_details?.community_name
                  }
                </Text>
              </Text>
              <Text style={styles.props}>
                HOA Fee Includes: {' '} <Text style={styles.communityText}>
                  {data?.hoa_fee}
                </Text>
              </Text>
              <Text style={styles.props}>
          ...
          <View style={styles.viewstyle}>
            <View style={styles.detailmiddleview}>
              ...
              <Text style={styles.props}>
                A/C: {' '}  <Text style={styles.fontstyle}>
                  {data?.details?.interior_features?.A_C}
                </Text>
              </Text>
              <Text style={styles.props}>
                Heating: {' '} <Text style={styles.fontstyle}>
                  {data?.details?.interior_features?.heating}
                </Text>
              </Text>
              <Text style={styles.props}>
                Flooring: {' '}  <Text style={styles.fontstyle}>
                  {data?.details?.interior_features?.flooring}{' '}
                </Text>
              </Text>
              <Text style={styles.props}>
                Property Rooms: {' '} <Text style={styles.fontstyle}>
            ...
            <View style={styles.detailmiddleview}>
              ...
              <Text style={styles.props}>
                Architectural Style: {' '} <Text style={styles.fontstyle}>
                  {data?.details?.exterior_features?.architecturalstyle
                  }
                </Text>
              </Text>
              <Text style={styles.props}>
                Construction: {' '} <Text style={styles.fontstyle}>
                  {data?.details?.exterior_features?.construction
                  }
                </Text>
              </Text>
              <Text style={styles.props}>
                Roofing: {' '} <Text style={styles.fontstyle}>
                  {data?.details?.exterior_features?.roofing}{' '}
                </Text>
              </Text>
              <Text style={styles.props}>
                Water Source: {' '} <Text style={styles.fontstyle}>
          ...
          <View style={styles.viewstyle}>
            <View style={styles.detailbottomview}>
              ...
              <Text style={styles.props}>
                Driving Directions: {' '} <Text style={styles.detailbottomtext}>
                  {data?.details?.miscellaneous_details?.driving_directions
                  }
                </Text> {' '}
              </Text>
              <Text style={styles.props}>
                Listing Office: {' '} <Text style={styles.detailbottomtext}>
                  {data?.details?.miscellaneous_details?.listing_office
                  }
                </Text> {' '}
              </Text>
              <Text style={styles.props}>
                Listing Agent: {' '}  <Text style={styles.detailbottomtext}>
                  {data?.details?.miscellaneous_details?.listing_agent
                  }
                </Text>{' '}
              </Text>
              <Text style={styles.props}>
                Listing Office Phone: {' '} <Text style={styles.detailbottomtext}>
                  {data?.details?.miscellaneous_details?.listing_office_phone
                  }
                </Text> {' '}
              </Text>
              <Text style={styles.props}>
                Data Disclaimer: {' '} <Text style={styles.detailbottomtext}>
              ...
              renderItem={({item}) => (
                <>
                  <View
                    ...
                    <View
                      style={styles.nearbyView2}>
                      <Text
                        style={styles.unitname}>
                        {item.unite_name}
                      </Text>
                      <Text
                        style={styles.unitdistance}>
                        {item.unit_distance}
                      </Text>
                    </View>
      ...
      <KeyboardAvoidingView>
        ...
        <View style={styles.cynithiaView}>
          ...
          <View style={styles.messageView}>
            {
              loading && <Text style={styles.messageText1}>{message}</Text>
            }

            {
              loading && <View style={styles.xyz}>
            ...
            <View style={styles.textinputView}>
              ...
              <TouchableOpacity
                onPress={() => {
                  ...
                  dispatch(schoolChat(formData)).then((ress) => {
                    setLoading(false);
                    const newTodo1 = {
                      type: 0,
                      message: message,
...
<TouchableOpacity
  ...
  <Image
    ...
    source={Images.leftnewarrow}></Image>
        ...
        <View
            style={[styles.cardswipeview2,{ height: firstViewHeight,}]}>
            <View
              style={styles.cardswipe4}>
              <View
                style={styles.cardswipeview3}>
                ...
                <CardsSwipe
                  ...
                  renderNope={() =>
                    props.route.params.from === 'MyFavorites' || props.route.params.from === 'Home' ?
                      <View
                        style={[styles.nopeView,{height: screenHeight+500, width:screenWidth - 16 }]}>
                        <View style={[styles.nopeView1,{ height: screenHeight - firstViewHeight - 27}]}>
                          <View
                            style={styles.nopeView2}>
                            <Image
                  ...
                  renderYep={() => (
                    props.route.params.from === 'RecycleBin' || props.route.params.from === 'Home' ?
                      <View
                        style={[styles.yepView,{ height:  screenHeight+500, width: screenWidth, }]}>
                        <View style={[styles.nopeView1,{ height: screenHeight - firstViewHeight - 27}]}>
                          <View
                            style={styles.nopeView2}>
                            <Image
          ...
          <View style={styles.view11} >
            {
              property?.content.rendered?       <View>
              <>
        ...
        <Text style={styles.cynthia}>Hi I'm Cynthia. What can I help you with today ?</Text>
        ...
        <View style={styles.view4}>
          {
            loading && <Text style={styles.messagecynthia}>{message}</Text>
          }
        ...
        <TouchableOpacity
          onPress={() => {
            navigation.navigate('BookaTour', {
              PropID: data?.ID,
              user2_id:data?.user2_id? data?.user2_id:0
            });
...
lottieview:{ 
  ...
  tourtext:{
    fontSize: DeviceInfo.getDeviceType() === 'Tablet' ? 30 : 15,
    color: Colors.white,
    textAlign: 'center',
  left:10,
...
locationImagestyle:{height: 50, width: 100, resizeMode: 'contain'},
  ...
  communityText:{ fontFamily: 'Poppins-Light',
...
textinputView:{
  ...
  textinputstyle3:{ width: '90%', backgroundColor: Colors.white, color: Colors.black  },
...
reloadView:{ flexDirection: 'row', justifyContent: 'space-around', marginRight: 0 },

cynthiaText:{ fontSize: 15, fontFamily: 'Poppins-Medium', color: Colors.black },
