      ...
      <View style={styles.slideOuter}>
        <View style={styles.imageview}>
          ...
          <View style={styles.feedarrowview}>
            ...
            <Image source={Images.feedarrow} style={styles.feedarrowimagestyle} />
            <Image source={Images.feedarrow} style={[styles.feedarrowimagestyle,{  transform: 'rotate(180deg)' }]} />
          </View>
          <View style={styles.layerfavView}>
            ...
            >
              <Image source={Images.layerfav} style={[styles.imagelayerfav,{  transform: 'rotate(180deg)' }]} />
            </TouchableOpacity>
          </View>
        </View>
    ...
    <SafeAreaView style={{ flex: 1 }}>
      <View style={styles.headermain}>
        ...
        <View style={styles.centercover}>
          <Text style={styles.centertext}>Surf Picks</Text>
        </View>
        <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  headercover: {
    fontSize: DeviceInfo.getDeviceType() === 'Tablet' ? 32 : 14,
    color: Colors.black,
    fontFamily: 'Poppins-Medium',
    marginLeft: 6,
