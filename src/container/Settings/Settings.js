...
const Settings = props => {
        ...
        <TouchableOpacity
          ...
          <View
            ...
            {image != null ? (
              ...
              <Text style={styles.staticText}>JD</Text>
            )}
  ...
  onChangeText={text => setMob(text || '')}
        ...
        <TextInput
          allowFontScaling={false}
          style={styles.textinputstyle} placeholder='Facebook'
          placeholderTextColor={'black'}
          keyboardType="default"
          returnKeyType="done"
          value={facebook}
        ...
        <TextInput
          allowFontScaling={false}
          style={styles.textinputstyle} placeholder='Twitter'
          placeholderTextColor={'black'}
          value={twitter}
          keyboardType="default"
          returnKeyType="done"
        ...
        <TextInput
          allowFontScaling={false}
          style={styles.textinputstyle} placeholder='Instagram'
          placeholderTextColor={'black'}
          value={instagram}
          keyboardType="default"
          returnKeyType="done"
        ...
        <TextInput
          allowFontScaling={false}
          style={styles.textinputstyle} placeholder='Threads'
          placeholderTextColor={'black'}
          value={threads}
          keyboardType="default"
          returnKeyType="done"
