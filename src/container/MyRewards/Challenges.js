              ...
              return (
                <View style={{}}>
                  <View style={styles.questionmain}>
                    <Animatable.View key={animationKey} animation="bounceIn">
      ...
      {question.length > 0 ? (
        <View style={styles.upthumbView}>
          <TouchableOpacity
            ...
            activeOpacity={0.1}>
            <Image source={Images.next} style={[styles.upthumpdesarw, {}]} />
          </TouchableOpacity>
        </View>
      ) : null}
...
const styles = StyleSheet.create({
  ...
  challestext: {
    textAlign: 'center',
    width: '100%',
    fontSize: DeviceInfo.getDeviceType() === 'Tablet' ? 34 : 20,
